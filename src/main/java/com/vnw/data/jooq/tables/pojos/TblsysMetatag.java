...
public class TblsysMetatag implements Serializable {

    private static final long serialVersionUID = -815780518;
    ...
    public TblsysMetatag(TblsysMetatag value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TblsysMetatag (");
