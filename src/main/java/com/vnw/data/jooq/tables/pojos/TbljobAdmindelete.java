...
public class TbljobAdmindelete implements Serializable {

    private static final long serialVersionUID = 101763069;
    ...
    public TbljobAdmindelete(TbljobAdmindelete value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TbljobAdmindelete (");
