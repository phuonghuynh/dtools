...
public class TbljobVip implements Serializable {

    private static final long serialVersionUID = 1096173417;
    ...
    public TbljobVip(TbljobVip value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TbljobVip (");
