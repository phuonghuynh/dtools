...
public class Getjobseekercontactinfo extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -286645632;

    /**
     * The parameter <code>vnw_core.getJobSeekerContactInfo.in_userId</code>.
     */
    public static final Parameter<Integer> IN_USERID = createParameter("in_userId", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>vnw_core.getJobSeekerContactInfo.in_userEmail</code>.
     */
     ...
     */
    public Getjobseekercontactinfo() {
        super("getJobSeekerContactInfo", VnwCore.VNW_CORE);
