...
public class Getuserskills extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1235091839;

    /**
     * The parameter <code>vnw_core.getUserSkills.in_userId</code>.
     */
    public static final Parameter<Integer> IN_USERID = createParameter("in_userId", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>vnw_core.getUserSkills.in_userEmail</code>.
     */
    ...
    public Getuserskills() {
        super("getUserSkills", VnwCore.VNW_CORE);
