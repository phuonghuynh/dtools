...
public class Getresumeindustries extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1818429731;

    /**
     * The parameter <code>vnw_core.getResumeIndustries.in_userId</code>.
     */
    public static final Parameter<Integer> IN_USERID = createParameter("in_userId", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>vnw_core.getResumeIndustries.in_userEmail</code>.
     */
     ...
     */
    public Getresumeindustries() {
        super("getResumeIndustries", VnwCore.VNW_CORE);
