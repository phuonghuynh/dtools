...
public class Getworkingpreferences extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1515709531;

    /**
     * The parameter <code>vnw_core.getWorkingPreferences.in_userId</code>.
     */
    public static final Parameter<Integer> IN_USERID = createParameter("in_userId", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>vnw_core.getWorkingPreferences.in_userEmail</code>.
     */
     ...
     */
    public Getworkingpreferences() {
        super("getWorkingPreferences", VnwCore.VNW_CORE);
