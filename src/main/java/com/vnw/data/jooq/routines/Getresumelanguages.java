...
public class Getresumelanguages extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1213737780;

    /**
     * The parameter <code>vnw_core.getResumeLanguages.in_userId</code>.
     */
    public static final Parameter<Integer> IN_USERID = createParameter("in_userId", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>vnw_core.getResumeLanguages.in_userEmail</code>.
     */
     ...
     */
    public Getresumelanguages() {
        super("getResumeLanguages", VnwCore.VNW_CORE);
